...
import 'package:testapp/components/explore/header.dart';
...
class ExploreProfilePage extends StatefulWidget {
  ...
  const ExploreProfilePage({
    super.key,
    required this.currentPath,
  });

  @override
  State<ExploreProfilePage> createState() => _HomePageState();
}
...
class _HomePageState extends State<ExploreProfilePage>
                ...
                delegate: SliverChildBuilderDelegate(
                  (BuildContext context, index) {
                    return Padding(
                      ...
                      child: ExploreHeader(currentPath: widget.currentPath),
                    );
                  },
                  childCount: 1,
                ),
