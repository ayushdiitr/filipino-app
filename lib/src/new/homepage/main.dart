...
final userProvider = FutureProvider<List<dynamic>>((ref) async {
  final String apiUrl = 'http://35.154.234.237/getAllUsers/';
  try {
...
class _HomePageState extends ConsumerState<HomePage>
  ...
  List<dynamic>? _getUsers() {
    final usersAsyncValue = ref.read(userProvider);
    if (usersAsyncValue is AsyncData) {
      return usersAsyncValue.value;
    }
    return null;
  }
